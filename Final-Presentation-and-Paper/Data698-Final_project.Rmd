...
* Positive correlations between: `Weight(kg)` and `BMI`, `Married(yrs)` and `Age(yrs)`, and `Follicle_No(L)`, `Follicle_No(R)` and `PCOS(Y/N)` to name a few.

* Negative correlations between: `Hip(cm)` and `Waist-Hip_Ratio)`, `AMH(ng/mL)` and `Age(yrs)`, and `Cycle(R/I)` and  `Follicle_No(R)`.
...
p1 <- pcos_cleaned %>% 
  ggplot(aes(x=`Age(yrs)`, y=`Weight(kg)`, color=as.factor(`PCOS(Y/N)`))) + 
    geom_point() +
    geom_smooth(method="lm", se=FALSE) +
    scale_colour_discrete("PCOS(Y/N)", labels = c("No", 
    "Yes")) +
...
p2 <- pcos_cleaned %>% 
  ggplot(aes(x=`Hip(cm)`, y=`Waist(cm)`, color=as.factor(`PCOS(Y/N)`))) + 
    geom_point() +
    geom_smooth(method="lm", se=FALSE) +
    scale_colour_discrete("PCOS(Y/N)", labels = c("No", 
    "Yes")) +
...
p3 <- pcos_cleaned %>% 
  ggplot(aes(x=`Waist-Hip_Ratio`, y=`RBS(mg/dl)`, color=as.factor(`PCOS(Y/N)`))) + 
    geom_point() +
    geom_smooth(method="lm", se=FALSE) +
    scale_colour_discrete("PCOS(Y/N)", labels = c("No", 
    "Yes")) +
...
p4 <- pcos_cleaned %>% 
ggplot(aes(x=`Age(yrs)`, y=`Cycle_length(days)`, color=as.factor(`PCOS(Y/N)`))) + 
    geom_point() +
    geom_smooth(method="lm", se=FALSE) +
...
p5 <- pcos_cleaned %>% 
ggplot(aes(x=`Age(yrs)`, y=`Cycle(R/I)`, color=as.factor(`PCOS(Y/N)`))) + 
    geom_point() +
    geom_smooth(method="lm", se=FALSE) +
    scale_colour_discrete("PCOS", labels = c("No", 
    "Yes")) +
...
p6 <- pcos_cleaned %>% 
ggplot(aes(x=`Age(yrs)`, y=BMI, color=as.factor(`PCOS(Y/N)`))) + 
    geom_point() +
    geom_smooth(method="lm", se=FALSE) +
    scale_colour_discrete("PCOS", labels = c("No", 
    "Yes")) +
...
p7 <- pcos_cleaned %>% 
ggplot(aes(x=`Follicle_No(R)`, y=`Follicle_No(L)`, color=as.factor(`PCOS(Y/N)`))) + 
    geom_point() +
    geom_smooth(method="lm", se=FALSE) +
    scale_colour_discrete("PCOS", labels = c("No", 
    "Yes")) +
...
p8 <- pcos_cleaned %>% 
ggplot(aes(x=`Avg_F_size(R)(mm)`, y=`Avg_F_size(L)(mm)`, color=as.factor(`PCOS(Y/N)`))) + 
    geom_point() +
    geom_smooth(method="lm", se=FALSE) +
    scale_colour_discrete("PCOS", labels = c("No", 
    "Yes")) +
...
p9 <- pcos_cleaned %>% 
ggplot(aes(x=`Endometrium(mm)`, y=`Cycle_length(days)`, color=as.factor(`PCOS(Y/N)`))) + 
    geom_point() +
    geom_smooth(method="lm", se=FALSE) +
    scale_colour_discrete("PCOS", labels = c("No", 
    "Yes")) +
...
p10 <- pcos_cleaned %>% 
  ggplot(aes(x = as.factor(`PCOS(Y/N)`), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") + 
    geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
    scale_fill_discrete(name = "PCOS(Y/N)", labels = c("No", "Yes")) +
...
p23 <- pcos_cleaned %>% 
  ggplot(aes(x = as.factor(`Married(yrs)`))) +
    geom_histogram(stat="count", show.legend = FALSE, fill = "#69b3a2", color = "#e9ecef", alpha=0.9) +
    geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
```{r, echo=FALSE, warning=FALSE, fig.height=10, fig.width=12, message=FALSE}
p31 <- pcos_cleaned %>% 
ggplot(aes(x=`Ibeta-HCG(mIU/mL)`, y=`IIbeta-HCG(mIU/mL)`, color=as.factor(`PCOS(Y/N)`))) + 
    geom_point() +
    geom_smooth(method="lm", se=FALSE) +
    scale_colour_discrete("PCOS", labels = c("No", 
    "Yes")) +
...
p32 <- pcos_cleaned %>% 
  ggplot(aes(x = as.factor(`Vit_D3(ng/mL)`), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    #geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p33 <- pcos_cleaned %>% 
  ggplot(aes(x = as.factor(`FSH-LH`), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    #geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p34 <- pcos_cleaned %>% 
ggplot(aes(x=`BP_Diastolic(mmHg)`, y=`BP_Systolic(mmHg)`, color=as.factor(`PCOS(Y/N)`))) + 
    geom_point() +
    geom_smooth(method="lm", se=FALSE) +
    scale_colour_discrete("PCOS", labels = c("No", 
    "Yes")) +
...
p35 <- pcos_cleaned %>% 
ggplot(aes(x=`RR(breaths/min)`, y=`Pulse_rate(bpm)`, color=as.factor(`PCOS(Y/N)`))) + 
    geom_point() +
    geom_smooth(method="lm", se=FALSE) +
    scale_colour_discrete("PCOS", labels = c("No", 
    "Yes")) +
...
p36 <- pcos_cleaned %>% 
ggplot(aes(x=`AMH(ng/mL)`, y=`FSH-LH`, color=as.factor(`PCOS(Y/N)`))) + 
    geom_point() +
    geom_smooth(method="lm", se=FALSE) +
    scale_colour_discrete("PCOS", labels = c("No", 
    "Yes")) +
...
p37 <- pcos_cleaned %>% 
  ggplot(aes(x = as.factor(`TSH(mIU/L)`), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    #geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p38 <- pcos_cleaned %>% 
  ggplot(aes(x = as.factor(`Hb(g/dl)`), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    #geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p39 <- pcos_cleaned %>% 
  ggplot(aes(x = as.factor(`PRL(ng/mL)`), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    #geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p40 <- pcos_cleaned %>% 
  ggplot(aes(x = as.factor(`RBS(mg/dl)`), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    #geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p41 <- pcos_cleaned %>% 
  ggplot(aes(x = Blood_Group, fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    #geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p42 <- pcos_cleaned %>% 
  ggplot(aes(x = as.factor(Pregnant), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p43 <- pcos_cleaned %>%
  ggplot(aes(x = as.factor(Weight_gain), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p44 <- pcos_cleaned %>%
  ggplot(aes(x = as.factor(Hair_growth), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p45 <- pcos_cleaned %>%
  ggplot(aes(x = as.factor(Skin_darkening), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p46 <- pcos_cleaned %>%
  ggplot(aes(x = as.factor(Hair_loss), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p47 <- pcos_cleaned %>%
  ggplot(aes(x = as.factor(Pimples), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p48 <- pcos_cleaned %>%
  ggplot(aes(x = as.factor(Fast_food), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p49 <- pcos_cleaned %>%
  ggplot(aes(x = as.factor(Reg_Exercise), fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p50 <- pcos_cleaned %>% 
  ggplot(aes(x = `Cycle_length(days)`, fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
    #geom_text(aes(label = ..count..), position = position_dodge(width = 1), stat = "count", vjust = 1.5, colour = "black") +
...
p51 <- pcos_cleaned %>% 
  ggplot(aes(x = No_of_abortions, fill = as.factor(`PCOS(Y/N)`))) +
    geom_bar(position = "dodge") +
...
To start the model building we start by splitting the dataset into training and validation sets for machine learning models. The training set is used to train the model, while the validation set helps evaluate its performance. The 75:25 ratio used strikes a balance between having enough data to train the model effectively and having a substantial validation set for robust evaluation.
...
The initial decision tree constructed is based on `PCOS(Y/N)` against the entire dataset. Employing a 75:25 cross-validation approach to divided the data I created the decision tree. The output is below:
...
Upon examining the individual contributions of each variable. It's evident that `Follicle_No(L)`, `Follicle_No(R)`, `Hair_growth`, `Skin_darkening`, and `Weight_gain`, hold significant influence within the dataset. I expected a wider range of influential bloodwork-related tests beyond those presented in this outcome.
...
The second decision tree is based off the variables with the highest contribution: `Follicle_No(L)`, `Follicle_No(R)`, `Hair_growth`, `Skin_darkening`, `Weight_gain` and the target variable `PCOS(Y/N)`. The results are below:
...
# rf_model <- randomForest("PCOS(Y/N)" ~ ., data = train)
# rf_model
# 
# # prediction
...
# 
# # confusion matrix
# confusionMatrix(rf_result, as.factor(valid$"PCOS(Y/N)"))
```
...
# confusionMatrix(svm_result, valid$`PCOS(Y/N)`)
```
...
set.seed(13)
# create the model
nn_model <-  neuralnet(`PCOS(Y/N)`~Follicle_No(L) + Follicle_No(R) + Hair_growth + Skin_darkening + Weight_gain,
data=train,
hidden=c(1,1), # specify the number of hidden layers and the number of neurons in each layer. In this case, there are two hidden layers with four and two neurons, respectively.
linear.output = FALSE,
...
# print the table
table(valid$`PCOS(Y/N)`, prediction_label)
```

```{r, echo=FALSE}
# checking the accuracy
check <- as.numeric(valid$`PCOS(Y/N)`) == max.col(pred)
