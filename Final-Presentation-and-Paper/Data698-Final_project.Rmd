...
```{r, echo=FALSE}
pcos <- read.csv("https://raw.githubusercontent.com/letisalba/Data-698/master/Data-Collection-and-Analysis/Kaggle%20csv/PCOS_infertility.csv")
pcos2 <- read.csv("https://raw.githubusercontent.com/letisalba/Data-698/master/Data-Collection-and-Analysis/Kaggle%20csv/PCOSData_without_infertility.csv")
```


Lets view the `pcos` data with infertility:
```{r, echo=FALSE}
head(pcos, 4)
```

... And the `pcos2` data without infertility:
```{r, echo=FALSE}
head(pcos2, 4)
```
